# Regression cases: 5-error-handling-observability
...
---
id: <case-id>
factor: 5-error-handling-observability
level: <1-3>
...
## History
- YYYY-MM-DD: missed, patch proposed and applied to factors/5-error-handling-observability.md
...
`pr-review/factors/5-error-handling-observability.md` — the same isolated shape a real factor
