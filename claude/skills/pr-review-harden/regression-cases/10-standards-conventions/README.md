# Regression cases: 10-standards-conventions
...
---
id: <case-id>
factor: 10-standards-conventions
level: <1-3>
...
## History
- YYYY-MM-DD: missed, patch proposed and applied to factors/10-standards-conventions.md
...
`pr-review/factors/10-standards-conventions.md` — the same isolated shape a real factor
