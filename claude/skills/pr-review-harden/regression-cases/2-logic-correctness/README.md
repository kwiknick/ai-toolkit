# Regression cases: 2-logic-correctness
...
## History
- YYYY-MM-DD: missed, patch proposed and applied to factors/2-logic-correctness.md
...
`pr-review/factors/2-logic-correctness.md` — the same isolated shape a real factor
