# Regression cases: 1-architectural-alignment
...
---
id: <case-id>
factor: 1-architectural-alignment
level: <1-3>
...
## History
- YYYY-MM-DD: missed, patch proposed and applied to factors/1-architectural-alignment.md
...
`pr-review/factors/1-architectural-alignment.md` — the same isolated shape a real factor
