# Regression cases: 9-documentation-contracts
...
---
id: <case-id>
factor: 9-documentation-contracts
level: <1-3>
...
## History
- YYYY-MM-DD: missed, patch proposed and applied to factors/9-documentation-contracts.md
...
`pr-review/factors/9-documentation-contracts.md` — the same isolated shape a real factor
