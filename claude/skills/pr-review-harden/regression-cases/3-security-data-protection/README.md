# Regression cases: 3-security-data-protection
...
## History
- YYYY-MM-DD: missed, patch proposed and applied to factors/3-security-data-protection.md
...
`pr-review/factors/3-security-data-protection.md` — the same isolated shape a real factor
