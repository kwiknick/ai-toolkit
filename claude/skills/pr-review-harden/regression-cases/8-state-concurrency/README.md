# Regression cases: 8-state-concurrency
...
## History
- YYYY-MM-DD: missed, patch proposed and applied to factors/8-state-concurrency.md
...
`pr-review/factors/8-state-concurrency.md` — the same isolated shape a real factor
