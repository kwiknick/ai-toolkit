# Regression cases: 6-test-adequacy
...
## History
- YYYY-MM-DD: missed, patch proposed and applied to factors/6-test-adequacy.md
...
`pr-review/factors/6-test-adequacy.md` — the same isolated shape a real factor
